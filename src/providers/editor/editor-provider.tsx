...
const initialEditorSate: EditorState['editor'] = {
  elements: [
    {
      content: [],
      id: '__body',
...
const initialHistoryState: HistoryState = {
  history: [initialEditorSate],
  currentIndex: 0,
};

const initialState: EditorState = {
  editor: initialEditorSate,
...
const updateAnElement = (
  ...
  if (action.type !== 'UPDATE_ELEMENT') {
    throw Error('you send wrong action type to update an element');
  }
  return editorArray.map(item => {
...
const deleteAnElement = (
  ...
  if (action.type !== 'DELETE_ELEMENT') {
    throw Error('you send wrong action type to DELETE an element');
  }
  ...
  switch (action.type) {
    ...
    case 'LOAD_DATA':
      return {
        ...
        editor: {
          ...initialState.editor,
          elements: action.payload.elements || initialEditorSate.elements,
...
export const useEditor = () => {
  ...
  if (!context) {
    throw new Error('Use editor hook must be used within the editor provider');
  }
  return context;
};
